...
func (c *Client) SubmitBlockAsync(block *vipsutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *vipsutil.Block, options *btcjson.SubmitBlockOptions) error {
