...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []vipsutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []vipsutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee vipsutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee vipsutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address vipsutil.Address, amount vipsutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address vipsutil.Address, amount vipsutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address vipsutil.Address,
	amount vipsutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address vipsutil.Address, amount vipsutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress vipsutil.Address, amount vipsutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress vipsutil.Address, amount vipsutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress vipsutil.Address, amount vipsutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress vipsutil.Address, amount vipsutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress vipsutil.Address, amount vipsutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress vipsutil.Address,
	amount vipsutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[vipsutil.Address]vipsutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[vipsutil.Address]vipsutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[vipsutil.Address]vipsutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[vipsutil.Address]vipsutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (vipsutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return vipsutil.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []vipsutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []vipsutil.Address, account string) (vipsutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []vipsutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []vipsutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (vipsutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (vipsutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (vipsutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (vipsutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (vipsutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (vipsutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (vipsutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (vipsutil.Address, error) {
...
func (c *Client) GetAccountAsync(address vipsutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address vipsutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address vipsutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address vipsutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]vipsutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]vipsutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := vipsutil.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]vipsutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount vipsutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount vipsutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount vipsutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount vipsutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount vipsutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount vipsutil.Amount,
...
func (c *Client) ValidateAddressAsync(address vipsutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address vipsutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]vipsutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]vipsutil.Amount)
	for k, v := range accounts {
		amount, err := vipsutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]vipsutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]vipsutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (vipsutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := vipsutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (vipsutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (vipsutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (vipsutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (vipsutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (vipsutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (vipsutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (vipsutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (vipsutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (vipsutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address vipsutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address vipsutil.Address) (vipsutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address vipsutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address vipsutil.Address, minConfirms int) (vipsutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address vipsutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address vipsutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address vipsutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address vipsutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*vipsutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return vipsutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address vipsutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address vipsutil.Address) (*vipsutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *vipsutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *vipsutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *vipsutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *vipsutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *vipsutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *vipsutil.WIF, label string, rescan bool) error {
