...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/vipstar-dev/vipsd/peer)
...
```bash
$ go get -u github.com/vipstar-dev/vipsd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/vipstar-dev/vipsd/peer#example-package--NewOutboundPeer)  
