...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/VIPSTARCOIN-electrum/vipsd/peer)
...
```bash
$ go get -u github.com/VIPSTARCOIN-electrum/vipsd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/VIPSTARCOIN-electrum/vipsd/peer#example-package--NewOutboundPeer)  
