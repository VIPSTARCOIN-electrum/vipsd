...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*vipsutil.Block, error) {
	...
	blocks := make([]*vipsutil.Block, 0, 256)
	genesis := vipsutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
