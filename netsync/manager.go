...
import (
	...
	peerpkg "github.com/VIPSTARCOIN-electrum/vipsd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*vipsutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *vipsutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *vipsutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *vipsutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
