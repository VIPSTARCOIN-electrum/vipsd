...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/VIPSTARCOIN-electrum/vipsd/netsync)
...
```bash
$ go get -u github.com/VIPSTARCOIN-electrum/vipsd/netsync
```
