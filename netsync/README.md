...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/vipstar-dev/vipsd/netsync)
...
```bash
$ go get -u github.com/vipstar-dev/vipsd/netsync
```
