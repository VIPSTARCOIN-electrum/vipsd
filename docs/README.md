...
btcd has a number of [configuration](http://godoc.org/github.com/VIPSTARCOIN-electrum/vipsd)
...
* [Configuring btcd with Tor](https://github.com/VIPSTARCOIN-electrum/vipsd/tree/master/docs/configuring_tor.md)
