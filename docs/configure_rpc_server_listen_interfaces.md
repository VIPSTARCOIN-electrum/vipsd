vipsd allows you to bind the RPC server to specific interfaces which enables you
...
|--rpclisten=:31914|all interfaces on port 31914|
|--rpclisten=0.0.0.0:31914|all IPv4 interfaces on port 31914|
|--rpclisten=[::]:31914|all IPv6 interfaces on port 31914|
|--rpclisten=127.0.0.1:31914|only IPv4 localhost on port 31914|
|--rpclisten=[::1]:31914|only IPv6 localhost on port 31914|
...
|--rpclisten=127.0.0.1:8337 --listen=[::1]:31914|IPv4 localhost on port 8337 and IPv6 localhost on port 31914|
|--rpclisten=:31914 --listen=:8337|all interfaces on ports 31914 and 8337|

The following config file would configure the vipsd RPC server to listen to all interfaces on the default port, including external interfaces, for both IPv4 and IPv6:
