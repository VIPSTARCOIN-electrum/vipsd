...
5. [How do I use bootstrap.dat with vipsd?](#Importing)
...
### 5. How do I use bootstrap.dat with vipsd?

vipsd comes with a separate utility named `addblock` which can be used to import
...
1. Stop vipsd if it is already running.  This is required since addblock needs to
   access the database used by vipsd and it will be locked if vipsd is using it.
