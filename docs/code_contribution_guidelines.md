...
reason, the vipsd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire vipsd
...
One of the major design goals of all core vipsd packages is to aim for complete
...
commits](https://github.com/vipstar-dev/vipsd/commits/master) for examples of
commit messages.
...
Rejoice as you will now be listed as a [contributor](https://github.com/vipstar-dev/vipsd/graphs/contributors)!
...
[ISC license](https://github.com/vipstar-dev/vipsd/blob/master/LICENSE).  This is
the same license as all of the code in the vipsd suite.
