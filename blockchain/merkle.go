...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*vipsutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *vipsutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *vipsutil.Block) error {
