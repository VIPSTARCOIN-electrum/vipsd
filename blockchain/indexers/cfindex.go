...
func storeFilter(dbTx database.Tx, block *vipsutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *vipsutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *vipsutil.Block,
