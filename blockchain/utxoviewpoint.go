...
func (view *UtxoViewpoint) AddTxOut(tx *vipsutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *vipsutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *vipsutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *vipsutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *vipsutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *vipsutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *vipsutil.Tx) (*UtxoViewpoint, error) {
