...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr vipsutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*vipsutil.Tx, error) {
...
func CreateBlock(prevBlock *vipsutil.Block, inclusionTxs []*vipsutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr vipsutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*vipsutil.Block, error) {
	...
	blockTxns := []*vipsutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := vipsutil.NewBlock(&block)
