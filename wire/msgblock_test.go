...
func TestBlockTxHashes(t *testing.T) {
	...
	hashStr := "c3bb9785e6994e8f965a664a475dc09cf525406eed0e6f64bad65269f66cf5b8"
	...
	tests := []struct {
		...
		// Block that claims to have ~uint64(0) transactions.
		{
			[]byte{
	            ...
	            0x24, 0x26, 0x46, 0x63, 0xE4, 0xB1, 0x21, 0x38, // MerkleRoot
				0x64, 0x48, 0xBB, 0x5A, // Timestamp
