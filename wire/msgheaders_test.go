...
func TestHeadersWire(t *testing.T) {
	...
	oneHeaderEncoded := []byte{
		...
		0x00, 0x00, 0x00, 0x20, // Version 536870912
		0x7C, 0xB7, 0x09, 0xEE, 0xB1, 0x06, 0x15, 0x13,
		0x5C, 0x29, 0x22, 0xA7, 0xA6, 0x69, 0xEE, 0xC6,
		0xE9, 0x6B, 0x10, 0x37, 0x61, 0x44, 0x64, 0xFB,
		0x79, 0x0F, 0xD3, 0xE1, 0x68, 0xD0, 0x00, 0x00, // PrevBlock
		0xB8, 0xF5, 0x6C, 0xF6, 0x69, 0x52, 0xD6, 0xBA,
		0x64, 0x6F, 0x0E, 0xED, 0x6E, 0x40, 0x25, 0xF5,
		0x9C, 0xC0, 0x5D, 0x47, 0x4A, 0x66, 0x5A, 0x96,
		0x8F, 0x4E, 0x99, 0xE6, 0x85, 0x97, 0xBB, 0xC3, // MerkleRoot
		0x61, 0xbc, 0x66, 0x49, // Timestamp
		0xff, 0xff, 0x00, 0x1f, // Bits
