...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/vipstar-dev/vipsd/connmgr)
...
```bash
$ go get -u github.com/vipstar-dev/vipsd/connmgr
```
