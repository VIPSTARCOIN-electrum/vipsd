...
var MainNetParams = Params{
	...
	DefaultPort: "31915",
	DNSSeeds: []DNSSeed{
		{"dnsseed.vipstarcoin.jp", true},
		{"explorer.vipstarcoin.jp", true},
		{"mpos.mofumofu.me", true},
	},
	...
	TargetTimespan:           time.Minute * 2,     // 2 minutes
	...
	// Checkpoints ordered from oldest to newest.
	Checkpoints: []Checkpoint{
		{0, newHashFromStr("0000d068e1d30f79fb64446137106be9c6ee69a6a722295c131506b1ee09b77c")},
		{1000, newHashFromStr("0000966ea0fed775d527fb31902270f01cafdfe53403be884080e2203bd43c74")},
		{244000, newHashFromStr("0000000000261d023630c17c99b686bc251eca6e044c75191d83d7f35cff530d")},
		{400000, newHashFromStr("00000000005845c3019379551f73d16a71ebbf4307cae40b16caa3d36440462f")},
	},
	...
	RuleChangeActivationThreshold: 15120, // 75% of MinerConfirmationWindow
	...
	// BIP 173.
	Bech32HRPSegwit: "vips", // always vips for main net

	// Address encoding magics
	PubKeyHashAddrID:        0x46, // starts with V
