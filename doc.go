...
/*
vipsd is a full-node vipstarcoin implementation written in Go.

The default options are sane for most users.  This means vipsd will work 'out of
...
parsed when vipsd starts up.  By default, the configuration file is located at
~/.vipsd/vipsd.conf on POSIX-style operating systems and %LOCALAPPDATA%\vipsd\vipsd.conf
...
Application Options:
  ...
  -a, --addpeer=            Add a peer to connect with at startup
      ...
      --listen=             Add an interface/port to listen for connections
                            (default all interfaces port: 31915, testnet: 32915)
  ...
  -P, --rpcpass=            Password for RPC connections
      ...
      --rpclisten=          Add an interface/port to listen for RPC connections
                            (default port: 31914, testnet: 32914)
